...
// 和onSubmitted一样，只是保持焦点的不同
  ...
  Future<bool> getMemberMuteStatus(String userID) async {
    ...
    if (widget.groupMemberList?.any((item) => (item?.userID == userID)) ??
        false) {
                          ...
                          children: [
                            ...
                            GestureDetector(
                                onTap: () {
                                  ...
                                  var more = MorePanelState();

                                  MorePanelState.sendMediaMessage(
                                      context, widget.conversationID, more);
                                },
                                child: SvgPicture.asset(
                                  'images/moments_photo.svg',
                                  package: 'tim_ui_kit',
                                  color: const Color.fromRGBO(68, 68, 68, 1),
                                  height: 28,
                                  width: 28,
                                )),
                            if (widget.showSendAudio && forbiddenText == null)
                              InkWell(
                                onTap: () async {
                                ...
                                child: showSendSoundText
                                    ...
                                    : TextField(
                                        ...
                                        style: const TextStyle(
                                            fontSize: 16,
                                            color: Color(0xff1F2320),
                                            fontFamily: "SinhalaMN"),
                                        //to fix... import issue
                                        // textStyle(
                                        //     color: const Color(0xff1F2320)),
                                        ...
                                        decoration: const InputDecoration(
                                            ...
                                            hintStyle: TextStyle(
                                                fontSize: 16,
                                                color: Color(0xff7F8A87),
                                                fontFamily: "SinhalaMN"),
                                            //to fix... import issue
                                            // textStyle(
                                            //     color: const Color(0xff7F8A87),
                                            //     fontSize: 16),
