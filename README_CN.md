...
## 1.项目简介
### 1.1项目概述 
Heyya是一款在线约会APP。Heyya最大的特点是用户全部都是真实用户,注册时需要上传真实照片和验证手机号码。Heyya致力于为用户提供真诚、安全的交友环境,帮助他们扩展现实生活中的社交圈子,建立稳定的关系,甚至找到合适的伴侣。  
Heyya利用大数据算法为每个用户推荐最适合的约会对象。Heyya简洁的界面和流畅的用户体验为用户提供了一个互动平台,让他们在上面建立联系、分享经历,发现共同的兴趣爱好。   
Heyya致力于打造一个积极正面的约会平台,在平台上强调人与人之间真诚的互动和理解的重要性。 
